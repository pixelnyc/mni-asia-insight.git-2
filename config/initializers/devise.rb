...
Devise.setup do |config|
  ...
  config.secret_key = '6638bb2a0f971743fccc9f01772e665e56fefdcfb7b24447dabfd67ec9ad3c8f3981c16d4b23e5c60ebf5ba4e0578c226194347483f1be5bbf6b20f28cb169b0'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'noreply@asia-insight.com'
  ...
  # config.pepper = 'f4feb1c8452f37e4ea221ecad1b9654840bde5a907887efd78db09bf0d699eb773d33757ac02eeccaaa7f5dc663f1a1c5ad0502b3ba64ef6877fbd1c5faef4f2'
  ...
  config.cas_login_url = "#{config.cas_base_url}activateAndLogin?sso_b=#{CAS_APP_KEY}"
  config.cas_logout_url = "#{config.cas_base_url}logout"
  config.cas_validate_url = "#{config.cas_base_url}proxyValidate"
