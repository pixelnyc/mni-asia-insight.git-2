class Graph < ActiveRecord::Base
  ...
  validates :name, :existing, :spread_min, :spread_max, :existing, :average_6, :average_9, :average_12,
            :period_3_name, :period_6_name, :period_9_name, :period_12_name, presence: true
